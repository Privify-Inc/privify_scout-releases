...
a California corporation ("Privify," "we," "us") governing your use of the
Privify Scout software, including all executable binaries, associated
files, and documentation provided with it (collectively, the "Software").

BY DOWNLOADING, INSTALLING, OR RUNNING THE SOFTWARE, YOU AGREE TO BE BOUND
BY THE TERMS OF THIS AGREEMENT. IF YOU DO NOT AGREE, DO NOT DOWNLOAD,
...
b. reverse engineer, decompile, disassemble, decrypt, extract, or
   otherwise attempt to derive or access the source code, underlying
   ideas, algorithms, file formats, or non-public APIs of the Software,
   except and only to the extent such restriction is expressly prohibited
   by applicable law notwithstanding this limitation;

c. distribute, sell, lease, rent, lend, sublicense, or otherwise transfer
   the Software or any rights granted herein to any third party;

d. remove, obscure, or alter any proprietary notices, labels, or marks on
   or in the Software;
...
Licensee shall comply with all applicable export control and economic
sanctions laws, including U.S. Export Administration Regulations, in its
use of the Software.

## 10. Governing Law

This Agreement is governed by the laws of the State of California, without
regard to its conflict of laws principles. Any dispute arising under this
